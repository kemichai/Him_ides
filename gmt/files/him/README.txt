...
The ESRI Shapefile version contains the structures, with kinematics for each structure included as attributes and as a code for use with a 'styles' file to display symbology.  The styles file, developed by Eric Cowgill at UC Davis, may be found and implemented following directions beginning in Section 2 of this manual:
