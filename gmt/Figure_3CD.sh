...
# ------------------------------------------------------------------------------------------------------------------- #
# Output name
out=frontiers_manu_figure_3CD.eps
# ------------------------------------------------------------------------------------------------------------------- #
...
# ------------------------------------------------------------------------------------------------------------------- #
awk '{print($1,$2,$3)}' projection1_hdd.dat | gmt psxy -Sci -i0,1,2s0.025 -W.5,black -R0/80/40/100.5 -JX15/-5 \
...
END
# ------------------------------------------------------------------------------------------------------------------- #
awk '{print($1,$2,$3)}' projection2_hdd.dat | gmt psxy -Sci -i0,1,2s0.025 -W.5,black -R0/60.5/40/100.5 -JX11.31/-5 \
